...
const Other_Contracts_Doc = (prop) => {
    ...
    const [Contractor_level, set_Contractor_level] = useState("a4") // Set Default Contractor_level for this page
    ...
    const calculateFinalPayableAmount = (record) => {
        ...
        const vatAmount = (requested_performance_amount * vat_percentage) / 100;
        const totalWorkAmount = (requested_performance_amount + vatAmount);
...
export default Other_Contracts_Doc;