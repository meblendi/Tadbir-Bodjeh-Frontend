...
const Construction_Doc = (prop) => {
    ...
    const [Contractor_level, set_Contractor_level] = useState("c") // Set Default Contractor_level for this page
...
export default Construction_Doc;