...
const Monthly_Functions_Doc = (prop) => {
    ...
    const [Contractor_level, set_Contractor_level] = useState("a2") // Set Default Contractor_level for this page
    ...
    const calculateFinalPayableAmount = (record) => {
        ...
        const performanceWithholdingAmount = (requested_performance_amount * performanceـwithholding_percentage) / 100;
        const vatAmount = (profit * vat_percentage) / 100;
        const totalWorkAmount = (requested_performance_amount + overtime + vatAmount + profit);
        const taxAmount = ((requested_performance_amount + overtime) * tax_percentage) / 100;
...
export default Monthly_Functions_Doc;