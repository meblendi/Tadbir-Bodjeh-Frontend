...
import Research_Doc from "@/app/Financial/Contract/Add_02_Reseach/page";
...
const App = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (price) => toPersianNumbers(numberWithCommas(Math.floor(price))),
    ...
    const exportToExcel = async () => {
        ...
        if (allData && allData.length > 0) {
            ...
            XLSX.writeFile(wb, "02-Research_Plan.xlsx");
