...
import Miscellaneous_Doc from "@/app/Financial/Contract/Add_04_Miscellaneous/page";
...
const App = () => {
    ...
    const fetchData = async (params = {}) => {
        ...
        try {
            ...
            const filteredData = allData
                .filter(item =>
                    ["d1", "d2"].includes(item.Contractor_level) &&
    ...
    const exportToExcel = async () => {
        ...
        if (allData && allData.length > 0) {
            ...
            XLSX.writeFile(wb, "04-Miscellaneous_Functions.xlsx");
